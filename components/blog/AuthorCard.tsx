...
export function AuthorCard({
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-mp-ink text-lg font-bold text-white shadow-xs"
      >
        {initials}
      </span>
      <div className="min-w-0 flex-1">
        <p className="text-[11px] font-bold uppercase tracking-[0.14em] text-mp-muted">
          Written by
        </p>
      ...
      <Link
        href="/about/"
        className="group inline-flex shrink-0 items-center gap-1.5 self-start rounded-full border border-mp-ink bg-white px-5 py-2 text-[13px] font-bold uppercase tracking-wider text-mp-ink hover:bg-mp-ink hover:text-white transition-all sm:self-center"
      >
        Meet author
